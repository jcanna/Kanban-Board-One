...
package extensions
{
	...
	public class SuperPanelPlus extends Panel {
		...
		[Bindable] public var escapeCloseEnabled:Boolean = false;
		...
		public function addListeners():void {
			...
			if (escapeCloseEnabled) {
				stage.addEventListener(KeyboardEvent.KEY_DOWN, checkForESCHandler);
			}
		}
		...
		public function checkForESCHandler(event:KeyboardEvent):void {
		...
		public function closeClickHandler(event:MouseEvent):void {
			if (stage != null)
				stage.removeEventListener(KeyboardEvent.KEY_DOWN, checkForESCHandler);
